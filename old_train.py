...
for epoch_num in range(pretrainEpochs+trainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        if i%100 == 99:
            ...
            print("Epoch no:",epoch_num+1,"| Epoch progress(%):",format(i/(len(trSet)/ba"| Avg train loss:",format(avg_tr_loss/100,'0.4f'),"| Acc:",format(avg_lat_acc,'0.4f'),format(avg_lon_acc,'0.4f'), "| Validation loss prev epoch",format(prev_val_loss,'0.4f'), "| ETA(s):",int(eta))

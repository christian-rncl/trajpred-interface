...
def main():
    ...
    parser.add_argument('--dtype', type=str, default='train',
                        help='Part of dataset to be trained on (train/val/test)')
...
def train(args):
    ...
    data_loader = SocialDataLoader(args.dtype, args.batch_size, args.seq_length, args.maxNumPeds, datasets, forcePreProcess=True)

    with open(os.path.join('save/retrained', 'social_config.pkl'), 'wb') as f:
        pickle.dump(args, f)
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(data_loader.num_batches):
                ...
                if (e * data_loader.num_batches + b) % args.save_every == 0 and ((e * data_loader.num_batches + b) > 0):
                    checkpoint_path = os.path.join('save/retrained', 'social_model.ckpt')
